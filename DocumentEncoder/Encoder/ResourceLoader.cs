...
public static class ResourceLoader
{
    ...
    {
        return assembly.GetManifestResourceStream(assembly.GetName().Name + ".Encoder.Resources." + resourceFile);
    }

    public static byte[] GetResource(Assembly assembly, string resourceFile)
    {
        var s = assembly.GetManifestResourceStream(assembly.GetName().Name + ".Encoder.Resources." + resourceFile);
